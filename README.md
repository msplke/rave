...
1. Make sure you have XCode and XCommand Line Tools installed [as shown on expo docs](https://docs.expo.dev/workflow/ios-simulator/).
   > **NOTE:** If you just installed XCode, or if you have updated it, you need to open the simulator manually once. Run `npx expo start` in the expo directory, and then enter `i` to launch Expo Go. After the manual launch, you can run `pnpm dev` in the root directory.
